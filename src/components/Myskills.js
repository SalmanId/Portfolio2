...
import { SiReact, SiIonic, SiAngular, SiSpring, SiFirebase, SiGit, SiJenkins, SiAdobexd, SiAdobephotoshop, SiAdobeillustrator, SiFlutter, SiDocker, SiSpringboot } from "react-icons/si";
...
const Myskills = () => {
  const skills = [
    ...
    { icon: <SiSpringboot />, title: "Springboot" },
